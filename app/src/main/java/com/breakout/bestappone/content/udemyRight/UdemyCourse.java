...
public class UdemyCourse implements Parcelable {
    ...
    public final static Creator<UdemyCourse> CREATOR = new Creator<UdemyCourse>() {


        @SuppressWarnings({
                "unchecked"
        })
        public UdemyCourse createFromParcel(Parcel in) { return new UdemyCourse(in); }

        public UdemyCourse[] newArray(int size) { return (new UdemyCourse[size]); }

    };

    protected UdemyCourse(Parcel in) {
        title = in.readString();
        url = in.readString();
        price = in.readString();
    ...
    public String getImage125H() { return image125H; }
    ...
    public void setPredictiveScore(Object predictiveScore) { this.predictiveScore = predictiveScore; }
    ...
    public void setCurriculumLectures(List<Object> curriculumLectures) { this.curriculumLectures = curriculumLectures; }
